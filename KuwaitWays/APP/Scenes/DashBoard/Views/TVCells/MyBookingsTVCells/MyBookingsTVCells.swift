...
class MyBookingsTVCells: TableViewCell {
    ...
    override func updateUI() {
        ...
        fromDatelbl.text = convertDateFormat(inputDate: cellInfo?.fromdate ?? "", f1: "dd MMM yyyy", f2: "dd MMM")
        toDatelbl.text = convertDateFormat(inputDate: cellInfo?.todate ?? "", f1: "dd MMM yyyy", f2: "dd MMM")
